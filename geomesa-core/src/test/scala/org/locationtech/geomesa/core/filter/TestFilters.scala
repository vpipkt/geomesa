...
object TestFilters {
  ...
  val attributeAndLargeGeometricPredicates = Seq(
    "attr2 = '2nd100001' AND DISJOINT(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23)))",
    // For mediumData, this next filter will hit and the one after will not.
    "attr2 = '2nd100001' AND INTERSECTS(geom, POLYGON ((45 20, 68 20, 68 47, 45 47, 45 20)))",
    "attr2 = '2nd100001' AND INTERSECTS(geom, POLYGON ((41 28, 62 28, 62 49, 41 49, 41 28)))",
    "attr2 ILIKE '2nd1%' AND CROSSES(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23)))",
    "attr2 ILIKE '2nd1%' AND INTERSECTS(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23)))",
    "attr2 ILIKE '2nd1%' AND OVERLAPS(geom, POLYGON ((41 28, 62 28, 62 49, 41 49, 41 28)))",
    "attr2 ILIKE '2nd1%' AND WITHIN(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23)))"
  )
  ...
  /**
   * Note: These queries select attributes based on current query planning. However, this may change
   * when more advanced query optimization is added to GeoMesa.
   */
  val attrIdxStrategyPredicates = Seq(
    "attr2 = 'val56' AND INTERSECTS(geom, POLYGON ((41 28, 62 28, 62 49, 41 49, 41 28)))",
    "attr2 = 'val56'",
    "attr1 = 'val56' AND attr2 = 'val56'",
    "attr2 = 'val56' AND attr1 = 'val3'",
    "attr1 = 'val56' AND attr1 = 'val57' AND attr2 = 'val56'",
    "attr2 = 'val56' AND INTERSECTS(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23))) AND dtg DURING 2005-08-08T00:00:00.000Z/2010-08-08T23:59:59.000Z",
    "dtg DURING 2005-08-08T00:00:00.000Z/2010-08-08T23:59:59.000Z AND attr2 = 'val56' AND INTERSECTS(geom, POLYGON ((45 23, 68 23, 68 47, 45 47, 45 23)))",
    "attr2 = 'val56' AND NOT (INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))))",
    "attr2 = 'val56' AND dtg BETWEEN '2005-07-01T00:00:00.000Z' AND '2010-07-31T00:00:00.000Z'",
    "dtg BETWEEN '2005-07-01T00:00:00.000Z' AND '2010-07-31T00:00:00.000Z' AND attr2 = 'val56'"
  )
