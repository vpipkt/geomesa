...
GeoMesa support for PySpark provides access to GeoMesa Accumulo data stores through the Spark Python API using the default Jupyter's built in Python kernel. See :ref:`pyspark`.
