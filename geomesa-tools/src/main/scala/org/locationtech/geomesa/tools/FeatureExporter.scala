...
import com.vividsolutions.jts.geom.{Point, Coordinate, Geometry}
...
import org.locationtech.geomesa.filter.function.{Convert2ViewerFunction, BasicValues, ExtendedValues, EncodedValues}
